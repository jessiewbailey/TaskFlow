...
from app.models.schemas import WorkflowEmbeddingConfig, WorkflowSimilarityConfig, Workflow
from app.models.pydantic_models import (
    WorkflowEmbeddingConfigCreate, WorkflowEmbeddingConfigUpdate, WorkflowEmbeddingConfigResponse,
    WorkflowSimilarityConfigCreate, WorkflowSimilarityConfigUpdate, WorkflowSimilarityConfigResponse
)
import structlog
...
@router.get("/{workflow_id}/embedding-config", response_model=Optional[WorkflowEmbeddingConfigResponse])
...
@router.get("/{workflow_id}/similarity-config", response_model=Optional[WorkflowSimilarityConfigResponse])
async def get_similarity_config(
    ...
    result = await db.execute(
        ...
        .where(WorkflowSimilarityConfig.workflow_id == workflow_id)
    )
    config = result.scalar_one_or_none()
