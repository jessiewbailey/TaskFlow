...
async def create_custom_instruction(
    ...
    if existing:
        ...
        logger.info("Updated existing custom instruction", 
        ...
        logger.info("Created new custom instruction", 
                   request_id=request_id, 
                   block_id=instruction.workflow_block_id)
        
        return response_data

@router.put("/{request_id}/custom-instructions/{instruction_id}", response_model=CustomInstructionResponse)
async def update_custom_instruction(
    ...
    logger.info("Updated custom instruction", 
...
async def delete_custom_instruction(
    ...
    logger.info("Deleted custom instruction", 
               instruction_id=instruction_id, 
               request_id=request_id)
