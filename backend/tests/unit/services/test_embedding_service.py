...
class TestEmbeddingService:
    ...
    def embedding_service(self, mock_qdrant_client, mock_ollama_client):
        ...
        with patch('app.services.embedding_service.QdrantClient', return_value=mock_qdrant_client):
            with patch('app.services.embedding_service.OllamaClient', return_value=mock_ollama_client):
